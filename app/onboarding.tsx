      ...
      <View className="w-full mb-6">
        ...
        <View className="bg-blue-50 p-4 rounded-xl flex-row items-start mb-8 border border-blue-100">
          ...
          <Text className="font-regular text-xs text-slate-600 ml-3 flex-1 leading-5">
            Importante: Este aplicativo é uma ferramenta de apoio e{" "}
            <Text className="font-bold">não substitui</Text> o tratamento
            psicológico ou médico profissional. Em caso de emergência, busque
            ajuda especializada.
          </Text>
        </View>
